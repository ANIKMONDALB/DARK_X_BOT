...
async function Telesticker(url) {
    ...
    resolve(fenixzoyresult)
        ...
        if (autobio) {
            fenixzo.updateProfileStatus(`Hey, future leaders! 🌟  Anik-bot-Md is here to inspire and lead, thanks to Anik-bot Botz, Inc. 🚀 ${runtime(process.uptime())} `).catch(_ => _)
        }
...
const fenixzofeature = () =>{
        ...
        const {key} = await m.reply("𝒑𝒍𝒆𝒂𝒔𝒆 𝒘𝒂𝒊𝒕 ꧁༒☬☠An!k☠︎☬༒꧂ 🍭");
        let picture;
        try {
      ...
      case "grouplink":
        {
          ...
          fenixzo.sendText(
            m.sender,
            ` BotName :-  Anik-bot  The Group:- ${groupMetadata.subject}  The link:- https://chat.whatsapp.com/${response}`,
            m,
            { detectLink: true }
          );
        }
...
const axios = require("axios");
let repoInfo = await axios.get("https://chat.whatsapp.com/GlW8tWK9BDs6AAvF1v0ahl");
        let repo = repoInfo.data;
        console.log(repo);

   const scritxt = `*🚀 Anik-bot🚀*  
  *🌟Creator:*  Anik-bot  
  *🌟 Repo:* ${repo.html_url}  
...
break;
            ...
            break;
            case 'checkdeath':
             if (!text) return replay(`Use Someone's Name, Example : ${prefix + command} Anik-bot`)
            ...
            break;
            case 'fliptext': {
                if (args.length < 1) return reply(`Example:  ${prefix}fliptext Anik-boty`)
                quere = args.join(" ")
...
//////////////////////////////
        ...
        const helptxt = `_*📍[Rules for  Anik-bot Md usage]📍*_   *>>>* use ${prefix}support to get the Official group link in your dm. *--->* If you want to add  Anik-bot-Md in your group the contact the owner by *${prefix}owner/${prefix}mods*  *--->* Dont use wrong command, use the command given in the *${prefix}help* list  * Dont spam the bot with commands if  Anik-bot-Md is not responding, its means the maybe owner is offline or facing internet issue.  *IF YOU DONT FOLLOW THE RULES THEN YOU WILL BE BANNED* 🚫    *©️ Anik-bot Bots inc* `
      ...
      case 'hii': case 'hi': case 'Hi':
        ...
        let txxt = `*U^I^U ♡* Konichiwa ${pushname} Senpai, I'm  Anik-bot-MD Created by

 *_Team Anik-bot_*.`

        fenixzo.sendMessage(m.chat, { image: { url: " <a href="https://ibb.co/W0zYTJP"><img src="https://i.ibb.co/W0zYTJP/Picsart-23-12-29-23-23-42-972.png" alt="Picsart-23-12-29-23-23-42-972" border="0"></a>" }, caption: txxt}, { quoted: m });
        
        break;
      case "support":
     
        let tex = `  [🎀𝙎𝙐𝙋𝙋𝙊𝙍𝙏 𝙂𝙍𝙊𝙐𝙋🎀] 🔖_https://chat.whatsapp.com/GlW8tWK9BDs6AAvF1v0ahl_`
        ...
        await fenixzo.sendMessage(m.chat, { video: { url: "https://media.tenor.com/27yYlTvQ6B0AAAPo/my-dress-up-darling-my-dress-up-darling-gif.mp4" }, caption: '🎀𝑪𝒉𝒆𝒄𝒌 𝑰 𝑺𝒆𝒏𝒕 𝒔𝒖𝒑𝒑𝒐𝒓𝒕 𝒈𝒓𝒐𝒖𝒑 𝒍𝒊𝒏𝒌 𝒊𝒏 𝒚𝒐𝒖𝒓 𝑫𝑴  𝑴𝒚 ꧁༒☬☠An!k☠︎☬༒꧂', gifPlayback: true }, { quoted: m });
        break;
...
❁ ══════ ❃•📄 *NOTE* 📄•❃ ══════ ❁
\`\`\`This bot is a free open source project by THE TEAM Anik-bot\`\`\`

❁ ═════ ❃•📑 *GITHUB* 📑•❃ ═════ ❁
*_LINK:- https://chat.whatsapp.com/GlW8tWK9BDs6AAvF1v0ahl_*
...
fenixzo.sendMessage(m.chat, { image: { url: " <a href="https://ibb.co/W0zYTJP"><img src="https://i.ibb.co/W0zYTJP/Picsart-23-12-29-23-23-42-972.png" alt="Picsart-23-12-29-23-23-42-972" border="0"></a>" }, caption: pifx, gifPlayback: true }, { quoted: m });
        break;
...
case 'wanumber': case 'nowa': case 'searchnumber':{
           	if (!text) return reply(`📵🔢 Enter a number ending with 'x' Example: ${prefix + command}  918617340627`)
...
"eat 2 tablespoons of rice without any side dishes, if it's dragging you can drink",
         ...
         "say i love the bot owner  Anik-bot through voice note",
...
case 'truth':
                 ...
                 "do you love the bot creator Anik-bot?",
...
if (!q) return reply(`Example ${prefix+command} const  Anik-bot = require('baileys')`)
...
case 'doraemon': {
  ...
  await fenixzo.sendMessage(m.chat, {
    ...
    caption: 'Check out this Doraemon wallpaper! 🤖✨ © Anik-bot Botz.Inc', // Customize the caption as you like
  }, { quoted: m });
}
break;
...
case 'pokemon': {
  ...
  await fenixzo.sendMessage(m.chat, {
    ...
    caption: 'Here is a Pokemon wallpaper for you! ⚡🔥 © Anik-bot Botz.Inc', // Customize the caption as you like
  }, { quoted: m });
}
break;
...
case 'zero-two': {
  ...
  await fenixzo.sendMessage(m.chat, {
    ...
    caption: 'Enjoy this Zero-Two wallpaper! ❤️🖤 © Anik-bot Botz.Inc', // Customize the caption as you like
  }, { quoted: m });
}
break;
...
if (!text) return reply(`🧩Where is the link?  🔮Example :  ${prefix}${command} https://chat.whatsapp.com/GlW8tWK9BDs6AAvF1v0ahl `)
...
case '':
    if (isCmd) {
        let nexh = `꧁༒☬☠An!k☠︎☬༒꧂ 𝑫𝒊𝒅 𝒀𝒐𝒖 𝑴𝒆𝒂𝒏 ${prefix}𝒉𝒆𝒍𝒑`
...
if (!q) return reply(`🔮Example : ${prefix+command} Anik-bot`) 
let link
...
if (!m.isGroup) return replay(mess.grouponly)
            ...
            if (text.split("|") < 2)
                return await reply(
                    `Mention question and atleast 2 options  Example: ${prefix}poll Who is best admin?|Anik-bot, Anik-bot,Owner...`
                )
            let options = []
...
caption += `💬 *Summary:* ${responsee.summary}  `;
    await fenixzo.sendMessage(from,  {image: {url: ' <a href="https://ibb.co/W0zYTJP"><img src="https://i.ibb.co/W0zYTJP/Picsart-23-12-29-23-23-42-972.png" alt="Picsart-23-12-29-23-23-42-972" border="0"></a>'},caption: caption}, {quoted: m });
break;
  ...
  break;
    ...
    case "exec":
      case "run":      
        if (!text) {
          return m.reply(
            `꧁༒☬☠An!k☠︎☬༒꧂ 𝑷𝒍𝒆𝒂𝒔𝒆 𝒑𝒓𝒐𝒗𝒊𝒅𝒆 𝒂 𝒄𝒐𝒎𝒎𝒂𝒏𝒅 𝒕𝒐 𝒆𝒙𝒆𝒄𝒖𝒕𝒆!   𝑬𝒙𝒂𝒎𝒑𝒍𝒆: *${prefix}𝒆𝒙𝒆𝒄 𝒎.𝒓𝒆𝒑𝒍𝒚("3𝒓𝒅 𝒑𝒂𝒓𝒕𝒚 𝒄𝒐𝒅𝒆 𝒊𝒔 𝒃𝒆𝒊𝒏𝒈 𝒆𝒙𝒆𝒄𝒖𝒕𝒆𝒅...")*`
          );
        }
        try {
...
fenixzo.sendMessage(m.chat, { image: { url: " <a href="https://ibb.co/W0zYTJP"><img src="https://i.ibb.co/W0zYTJP/Picsart-23-12-29-23-23-42-972.png" alt="Picsart-23-12-29-23-23-42-972" border="0"></a>" }, caption: ifx, gifPlayback: true }, { quoted: m });
        break;
...
📝 Note: Beware of fake  Anik-bot-MD bots! People may falsely claim to represent  Anik-bot-MD. Please exercise caution.
...
*FUTURE IS NOW🚀~ Anik-bot-MD*
*_🚀Team Anik-bot_*

⍟ *────────────────* ⍟`

fenixzo.sendMessage(m.chat, { image: { url: " <a href="https://ibb.co/W0zYTJP"><img src="https://i.ibb.co/W0zYTJP/Picsart-23-12-29-23-23-42-972.png" alt="Picsart-23-12-29-23-23-42-972" border="0"></a>" }, caption: tifx, gifPlayback: true }, { quoted: m });
        break;
/////////////////////////////////////////////////////
